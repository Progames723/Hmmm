...
gxx_compile:
	$(CXX) -c $(CXXFLAGS) dev_progames723_hmmm_GMP.cpp -o GMP.o -static -lgmp -lmpfr -lgmpxx -D__int64_t="long long"
	$(CXX) -c $(CXXFLAGS) dev_progames723_hmmm_utils_MathUtil.cpp -o MathUtil.o -static -D__int64_t="long long"
