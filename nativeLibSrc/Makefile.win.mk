...
override CXXFLAGS += -I"$(JAVA_CYGWIN)\include" -I"$(JAVA_CYGWIN)\include\win32" -O3 -std=c++23 -fPIC -D__int64_t="int64_t" -D__int64="int64_t"
else
override CXXFLAGS += -I"$(JAVA)\include" -I"$(JAVA)\include\win32" -O3 -std=c++23 -fPIC -D__int64_t="int64_t" -D__int64="int64_t"
endif
