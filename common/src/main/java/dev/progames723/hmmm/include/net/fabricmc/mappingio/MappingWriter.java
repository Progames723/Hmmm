...
import dev.progames723.hmmm.include.net.fabricmc.mappingio.format.enigma.EnigmaDirWriter;
import dev.progames723.hmmm.include.net.fabricmc.mappingio.format.enigma.EnigmaFileWriter;
import dev.progames723.hmmm.include.net.fabricmc.mappingio.format.jobf.JobfFileWriter;
import dev.progames723.hmmm.include.net.fabricmc.mappingio.format.proguard.ProGuardFileWriter;
import dev.progames723.hmmm.include.net.fabricmc.mappingio.format.simple.RecafSimpleFileWriter;
import dev.progames723.hmmm.include.net.fabricmc.mappingio.format.srg.CsrgFileWriter;
import dev.progames723.hmmm.include.net.fabricmc.mappingio.format.srg.JamFileWriter;
import dev.progames723.hmmm.include.net.fabricmc.mappingio.format.srg.SrgFileWriter;
import dev.progames723.hmmm.include.net.fabricmc.mappingio.format.srg.TsrgFileWriter;
import dev.progames723.hmmm.include.net.fabricmc.mappingio.format.tiny.Tiny1FileWriter;
import dev.progames723.hmmm.include.net.fabricmc.mappingio.format.tiny.Tiny2FileWriter;
