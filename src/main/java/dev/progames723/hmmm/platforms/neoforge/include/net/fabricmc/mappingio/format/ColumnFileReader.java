...
package dev.progames723.hmmm.platforms.neoforge.include.net.fabricmc.mappingio.format;

import dev.progames723.hmmm.platforms.neoforge.include.net.fabricmc.mappingio.format.tiny.Tiny2Util;
...
public final class ColumnFileReader implements Closeable {
	 ...
	 * In comparison to {@link Reader#mark(int)} this method stacks,
